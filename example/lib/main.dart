...
import 'package:polkawallet_plugin_reef_example/pages/assetsContent.dart';
import 'package:polkawallet_plugin_reef_example/pages/profileContent.dart';
import 'package:polkawallet_plugin_reef_example/pages/selectListPage.dart';
...
import 'package:polkawallet_plugin_reef_example/pages/homePage.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      title: 'Polkawallet Plugin REEF Demo',
