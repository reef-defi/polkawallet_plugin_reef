...
import 'package:polkawallet_plugin_reef/pages/governance/council/council.dart';
import 'package:polkawallet_plugin_reef/pages/governance/govExternalLinks.dart';
...
class _MotionDetailPageState extends State<MotionDetailPage> {
  ...
  Widget build(BuildContext context) {
    final Map dic = I18n.of(context).getDic(i18n_full_dic_reef, 'gov');
    final CouncilMotionData motion = ModalRoute.of(context).settings.arguments;
    return Observer(
        ...
        child: Row(
          children: <Widget>[
            ...
            Text(I18n.of(context)
                .getDic(i18n_full_dic_reef, 'gov')['detail'])
          ],
        ),
        onTap: () {
          setState(() {
